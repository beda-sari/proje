...
class Test_setting:
    ...
    def setup_method(self): 
        ...
        passwordInput.send_keys("P123456.")
    ...
    def test_password_update(self):
      ...
      self.driver.find_element(By.NAME, "currentPassword").send_keys("P123456.")
      self.driver.find_element(By.NAME, "password").click()
      self.driver.find_element(By.NAME, "password").send_keys("P1234567.")
      self.driver.find_element(By.NAME, "passwordConfirmation").click()
      self.driver.find_element(By.NAME, "passwordConfirmation").send_keys("P1234567.")
